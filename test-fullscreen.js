...
async function testFullScreen() {
  ...
  try {
    ...
    console.log('=== TESTING IN FULL SCREEN MODE ===\n');
    ...
    // Take screenshot
    await page.screenshot({ path: 'dashboard-fullscreen.png', fullPage: true });
    console.log('  Screenshot saved: dashboard-fullscreen.png');
    ...
    // Take screenshot
    await page.screenshot({ path: 'students-fullscreen.png', fullPage: true });
    console.log('  Screenshot saved: students-fullscreen.png');
