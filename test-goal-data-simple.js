...
async function testGoalDataPage() {
  ...
  try {
    ...
    await page.screenshot({ path: 'goal-data-before-chat.png', fullPage: true });
    console.log('Screenshot saved: goal-data-before-chat.png');
    ...
    await page.screenshot({ path: 'goal-data-after-chat.png', fullPage: true });
    console.log('Screenshot saved: goal-data-after-chat.png');
