...
async function testStudentsPageOnly() {
  ...
  try {
    ...
    console.log('=== TESTING STUDENTS PAGE ONLY ===\n');
    ...
    // Take screenshot
    await page.screenshot({ path: 'students-debug.png', fullPage: true });
    console.log('Screenshot saved: students-debug.png');
